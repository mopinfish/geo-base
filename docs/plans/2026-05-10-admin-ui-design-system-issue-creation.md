...
**Goal:** spec `docs/specs/2026-05-10-admin-ui-design-system-migration-design.md` に基づき、必要なラベル / マイルストーン / Epic Issue / 子 Issue 10 件 を GitHub に起票し、Project 8 のフィールド設定まで完了させる。
...
- ブランチ `docs/admin-ui-design-system-spec` 上に spec ファイル
  (`docs/specs/2026-05-10-admin-ui-design-system-migration-design.md`)
...
- [ ] spec 内のリンクが切れていない
- [ ] Issue 起票プラン（`docs/plans/2026-05-10-admin-ui-design-system-issue-creation.md`）と整合している
...
- spec: `docs/specs/2026-05-10-admin-ui-design-system-migration-design.md`
- spec PR: <SPEC_PR_URL>
