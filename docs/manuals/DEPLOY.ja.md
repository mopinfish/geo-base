...
> English: [DEPLOY.md](./DEPLOY.md) ・ 日本語: this page
...
| PostgreSQL + PostGIS | Fly.io (`geo-base-pg`) | internal: `geo-base-pg.internal` | [`docs/POSTGRES_SETUP.ja.md`](./docs/POSTGRES_SETUP.ja.md) |
...
- `AUTH_PROVIDER=local` のみサポート（`docs/AUTH_SETUP.ja.md`）
...
- DB 側: [`docs/POSTGRES_SETUP.ja.md`](./docs/POSTGRES_SETUP.ja.md) §4
- 認証: [`docs/AUTH_SETUP.ja.md`](./docs/AUTH_SETUP.ja.md) のトラブルシューティング

## 関連ドキュメント

- アーキテクチャ判断記録: [`docs/INFRA_MIGRATION_INVESTIGATION.md`](./docs/INFRA_MIGRATION_INVESTIGATION.md)
- 認可レビュー: [`docs/ACCESS_CONTROL_REVIEW.ja.md`](./docs/ACCESS_CONTROL_REVIEW.ja.md)
