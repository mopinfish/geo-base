...
class TestRemoveTeamTilesetPermission:
    def test_owner_can_remove(self, client_for, make_team_with_roles, make_tileset, attach_to_team):
        team = make_team_with_roles()
        ts_id = make_tileset(owner_id=team["owner_id"])
    ...
    def test_admin_can_remove(self, client_for, make_team_with_roles, make_tileset, attach_to_team):
        team = make_team_with_roles()
        ts_id = make_tileset(owner_id=team["admin_id"])
