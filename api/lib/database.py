...
- Local development: Connection pool
- Vercel (serverless): Per-request connections with retry
- Fly.io (containerized): Connection pool with retry
...
def get_connection() -> Generator:
    ...
    if _is_serverless():
        ...
        # Fly.io or local: use connection pool
        pool = get_pool()
        conn = None
        try:
            conn = pool.getconn()
